            ...
            <table class="table table-striped table-hover table-dark">
                ...
                @foreach($clientes as $item)
                    <tr>
                        ...
                        <td>{!!Form::open([ 'method'  => 'delete', 'route' => [ 'Cliente.destroy', $item->Dni ] ])!!}

                            <a href="{{route("Cliente.edit",$item->Dni)}}">
...
<a href="{{route("Cliente.create")}}"><button type="button" class="btn btn-primary">Insertar</button></a>
</div>
</div>
